 ...
 */
@Repository
public class IndexInfoDAOImpl extends BaseDAO<IndexInfo> implements IndexInfoDAO{

	@Override
	public String save(IndexInfo instance) {
		List rs = this.execSQLQuery("SELECT SEQ_INDEX_INFO.NEXTVAL FROM DUAL");
		Map nv = (Map) rs.get(0);
